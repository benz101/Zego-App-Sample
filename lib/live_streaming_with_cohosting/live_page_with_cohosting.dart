...
class LivePageWithCohosting extends StatefulWidget {
  final String liveID;
  final bool isHost;
  final String localUserID;

  const LivePageWithCohosting({
    super.key,
  ...
  @override
  State<StatefulWidget> createState() => LivePageWithCohostingState();
}

class LivePageWithCohostingState extends State<LivePageWithCohosting> {
  @override
